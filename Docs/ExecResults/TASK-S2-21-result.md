...
- `Autothink.UiaAgent.DemoTarget/MainForm.cs`
...
- `Docs/组态软件自动操作/Selectors/autothink.importVariables.local.json`
...
- `Docs/Samples/variables_demo.xlsx`
  - Demo 变量表占位文件。
...
- 日志：`logs/20260103-200145/summary.json`
```json
{
  "flows": [
...
- 日志：`logs/20260103-200145/autothink.importVariables.json`
```json
...
- 文件：`Docs/组态软件自动操作/Selectors/autothink.base.json`
```json
{
  "selectors": {
...
### 5.2 local（现场覆盖示例）
- 文件：`Docs/组态软件自动操作/Selectors/autothink.importVariables.local.json`
```json
{
  "selectors": {
    "importVariablesMenuOrButton": { "Path": [ { "Search": "Descendants", "ControlType": "Button", "AutomationId": "openImportButton", "Index": 0 } ] },
...
## 6. Runbook 更新片段
- 文件：`Docs/组态软件自动操作/Runbook-Autothink-普通型.md`
```text
