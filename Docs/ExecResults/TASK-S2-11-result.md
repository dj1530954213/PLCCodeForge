...
- **改动清单**：
  - `Autothink.UiaAgent/Flows/Autothink/AutothinkImportProgramTextPasteFlow.cs`：SearchRoot 解析与 root 记录。
  - `Autothink.UiaAgent/Flows/Autothink/AutothinkImportVariablesFlow.cs`：SearchRoot 解析与 root 记录。
  - `Autothink.UiaAgent/Flows/Autothink/AutothinkBuildFlow.cs`：SearchRoot 解析与 root 记录。
  - `Autothink.UiaAgent.Tests/AutothinkImportVariablesArgsTests.cs`：SearchRoot 校验测试。
  - `Autothink.UiaAgent.Tests/AutothinkBuildArgsTests.cs`：SearchRoot 校验测试。
