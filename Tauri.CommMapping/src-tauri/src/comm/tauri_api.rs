...
use super::model::{
    CommConfigV1, CommDeviceV1, CommExportDiagnostics, CommProjectDataV1, CommProjectUiStateV1,
    CommProjectV1, CommWarning, ConnectionProfile, PointsV1, ProfilesV1, RunStats, SampleResult,
    SCHEMA_VERSION_V1,
};
...
fn load_project_data_if_needed(
    app: &AppHandle,
...
fn profiles_from_device(device: &CommDeviceV1) -> ProfilesV1 {
    ProfilesV1 {
        schema_version: SCHEMA_VERSION_V1,
        profiles: vec![device.profile.clone()],
    }
...
fn scope_key(project_id: Option<&str>, device_id: Option<&str>) -> String {
