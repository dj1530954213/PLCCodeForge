...
internal static class AgentHost
{
    ...
    internal static int Run(string[] args)
    {
        ...
        try
        {
            ...
            Console.Error.WriteLine("[Agent] OpenImportDialogSteps actions: Click, DoubleClick, RightClick, ClickAt, RightClickAt, ClickRel, Hover, SetText, SendKeys, KeyNav, WaitUntil");
