...
/// <summary>
/// 基于锚点的点击请求基类（按锚点矩形左上角为原点）。
/// </summary>
public abstract class AnchorRequest
{
    /// <summary>
    /// 会话标识。
    /// </summary>
...
/// 按锚点坐标系偏移点击（左键）。
/// </summary>
public sealed class ClickAtRequest : AnchorRequest
{
    /// <summary>
    /// X 偏移（相对锚点左上角）。
    /// </summary>
...
/// 按锚点坐标系偏移右键点击。
/// </summary>
public sealed class RightClickAtRequest : AnchorRequest
{
    /// <summary>
    /// X 偏移（相对锚点左上角）。
    /// </summary>
...
/// 按锚点矩形比例点击（左键）。
/// </summary>
public sealed class ClickRelRequest : AnchorRequest
{
    /// <summary>
    /// X 比例（0-1）。
    /// </summary>
