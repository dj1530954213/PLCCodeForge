...
- **改动清单**：
  - `Autothink.UIA/Autothink.UiaAgent.Stage2Runner/Program.cs`：local override 加载 + summary.json 输出。
  - `Autothink.UIA/Docs/组态软件自动操作/Selectors/autothink.attach.json`
  - `Autothink.UIA/Docs/组态软件自动操作/Selectors/autothink.importProgram.textPaste.json`
  - `Autothink.UIA/Docs/组态软件自动操作/Selectors/autothink.importVariables.json`
  - `Autothink.UIA/Docs/组态软件自动操作/Selectors/autothink.build.json`
  - `Autothink.UIA/Docs/组态软件自动操作/Selectors/*.local.json`（本地覆盖，gitignore）
  - `Autothink.UIA/Docs/组态软件自动操作/Selectors/README.md`
...
- **Stage2Runner 运行日志片段（含 override/RunDir）**：
  ```text
  SelectorsRoot: C:\Program Files\Git\code\PLCCodeForge\Autothink.UIA\Docs\组态软件自动操作\Selectors
  Profile: autothink
  RunDir: C:\Program Files\Git\code\PLCCodeForge\Autothink.UIA\logs\20260103-123157
  Loaded baseline profile: ...\autothink.attach.json
  Loaded local override: ...\autothink.attach.local.json
  Summary written: ...\Autothink.UIA\logs\20260103-123157\summary.json
  ```
...
- **summary.json 示例（至少 2 个 flow）**：
  ...
  {
    "profile": "autothink",
    "runDir": "C:\\Program Files\\Git\\code\\PLCCodeForge\\Autothink.UIA\\Autothink.UIA\logs\\20260103-123157",
    "flows": [
...
- **Runbook 新增章节片段**：
  ...
  - 证据提交：Autothink.UIA/logs/<timestamp> + selectors(local/baseline) + config
  ```
